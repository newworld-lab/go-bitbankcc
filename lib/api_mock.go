...
func (m *MockAPI) GetTransactions(pair entity.TypePair, time *time.Time) (*entity.Transaction, error) {
...
func (m *MockAPI) GetCandlestick(pair entity.TypePair, candle TypeCandle, time time.Time) (entity.Candlestick, error) {
